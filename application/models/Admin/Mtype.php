 ...
 *
 *	Class ini untuk model tipe mobil
 *
 *	@subpackage			helper
*/
...
class Mtype extends CI_Model {
	...
	// fungsi mengambi data tipe mobil
	...
	// fungsi mengabil data tipe mobil dari id
	...
	// mengambil data tipe mobil per halaman
	/**
	 *
	...
	*/
	...
	public function save_edit_data()
	{
		...
		echo "Tipe mobil sudah disimpan";
	}
	...
	// menghapus tipe mobil
	public function delete_data($id)
	{
		$this->db->where('id_cat', $id);
		$this->db->delete('bb_category');

		echo "Tipe mobil sudah di hapus";
	}
