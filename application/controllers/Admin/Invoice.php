		...
		foreach($res as $row)
			{
				$result[] = array(
							...
							'action'	=> '<div id="delete" class="btn btn-danger" idmobil="'.$row->id_inv.'">
		...
		foreach($res as $row)
			{
				$result[] = array(
							...
							'date'		=> exDate($row->date_inv),
							'action'	=> '<div id="conf" class="btn btn-primary" idmobil="'.$row->id_inv.'">
            					<span class="glyphicon glyphicon-ok"></span></div> <div id="delete" class="btn btn-danger del" idmobil="'.$row->id_inv.'">
            					<span class="glyphicon glyphicon-trash"></span></div>'
							);
			}
		...
		foreach($res as $row)
			{
				$result[] = array(
							...
							'date'		=> exDate($row->date_inv),
							'action' 	=> '<div id="penal" class="btn btn-success" idmobil="'.$row->id_inv.'">Denda</div>'
							);
			}
		...
		foreach($res as $row)
			{
				$result[] = array(
							...
							'price'		=> 'Rp. '.rpCurrency($row->total_inv),
							'date'		=> exDate($row->date_inv),
							'action'	=> '<div id="delete" class="btn btn-danger del" idmobil="'.$row->id_inv.'">
            					<span class="glyphicon glyphicon-trash"></span></div>'
							);
			}
