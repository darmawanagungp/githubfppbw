...
<label class="ipt-title">Input Tipe mobil</label>
...
<form id="editForm">
  <div class="input-group">
    ...
    <input id="title" type="text" class="form-control" name="title" placeholder="Nama tipe mobil" value="<?php echo $td->name_cat;?>" required="">
  </div>
  <br>
    <input id="desc" type="text" name="desc" placeholder="Masukan deskripsi tipe mobil" class="file form-control" value="<?php echo $td->desc_cat;?>" required="">
  <br>


  <button type="submit" class="btn btn-primary" style="width: 100%;">Simpan Tipe mobil</button>
</form>
