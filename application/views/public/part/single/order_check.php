...
<div class="container">
	...
	<div class="right">
		...
		<p>
			Lengkapi isian di samping untuk melakukan pengecekan pemesanan mobil Anda.
		</p>
		...
		<p>
			<strong>No.Handphone</strong> adalah nomor telepon / handphone yang digunakan ketika melakukan pemesanan mobil di <?php echo $title_web;?>.
		</p>
